...
namespace Common
{
    public static class ConsoleHelper
    {
        ...
        public static void PrintBinaryClassificationMetrics(string name, CalibratedBinaryClassificationMetrics metrics)
        {
            ...
            Console.WriteLine($"*       Auprc:  {metrics.AreaUnderRocCurve:P2}");
        ...
        public static void PrintClusteringMetrics(string name, ClusteringMetrics metrics)
        {
            ...
            Console.WriteLine($"*------------------------------------------------");
            Console.WriteLine($"*       AvgMinScore: {metrics.AverageDistance}");
            Console.WriteLine($"*       DBI is: {metrics.DaviesBouldinIndex}");
            Console.WriteLine($"*************************************************");
        }
