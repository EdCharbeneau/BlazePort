...
namespace BlazePort
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=(localdb)\mssqllocaldb;Database=BlazePortDb;Trusted_Connection=True;ConnectRetryCount=0";
            services.AddDbContext<BlazePortContext>(options => options.UseSqlServer(connection));
        }
